    ...
    public class DisputasController : Controller
    {
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            ...
            try
            {
                ...
                string uriBaseHabilidades = "http://lzsouza.somee.com/RpgApi/PersonagemHablidades/GetHabilidaes";
                response = await httpClient.GetAsync(uriBaseHabilidades);
        ...
        public async Task<ActionResult> IndexHabilidadesAsync(DisputaViewModel disputa)
        {
            ...
            try
            {
                ...
                HttpResponseMessage reponse = await response.Content.ReadAsStringAsync();
